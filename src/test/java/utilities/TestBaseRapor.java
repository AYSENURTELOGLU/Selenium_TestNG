...
public abstract class TestBaseRapor {
    protected static ExtentReports extentReports; //extent report'a ilk atamayi yapar //protected çünkü child classlardan kullanacağız
    ...
    // Test işlemine başlamadan hemen önce (test methodundan önce değil, tüm test işleminden önce ibr kere çalışır)
    ...
    // Raporlandırmayı sonlandırmak icin tüm testler bittikten sonra bir kez çalışır
