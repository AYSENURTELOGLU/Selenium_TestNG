...
public class AmazonPage {
    ...
    public AmazonPage() { //constructor, farklı packagelar erişebilsin diye public olmalıdır.
        PageFactory.initElements(Driver.getDriver(), this);  // driver ı burada tanıttıgımız için driver.findelement'e gerek kalmıyor    }
    }
