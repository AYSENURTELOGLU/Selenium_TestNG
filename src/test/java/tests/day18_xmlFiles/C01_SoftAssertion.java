...
public class C01_SoftAssertion {
    ...
    public void zeroAppTesti (){
        ...
        //6. back tusuna basıp, Online banking menusu icinde Pay Bills sayfasina gidin
        ...
        softAssert.assertEquals(actualSecilmisOpsiyon,expectedSecilecekOpsiyon,"secilen opsiyon Eurozone değil");
       ...
       List<WebElement> dropdownElementleriList=select.getOptions(); //bizim expected listemiz string karşılaştıramyız. bu nedenle web element listesini stringe döndrmeliyiz.
        ...
        softAssert.assertAll(); // bunu yazmazsak failed olsada pass yazar. test yapmaz.
