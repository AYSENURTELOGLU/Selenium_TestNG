...
public class C05_QualitydemyNegatifLoginTesti {
    ...
    public void gecersizPasswordTest(){
        ...
        qualitydemyPage.passwordKutusu.sendKeys("12345"); //geçersizsifre
        qualitydemyPage.loginButonu.click();

        ReusableMethods.bekle(1);
        Assert.assertTrue(qualitydemyPage.emailKutusu.isDisplayed()); //hala email kutusu gözüküyorsa giris yapilmamistir
